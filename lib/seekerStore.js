...
export function ensureSeeded() {
  ...
  store.profile = {
    ...
    resume: { fileName: "Minh_Tran_CV.pdf", uploadedAt: daysAgo(20) },
  ...
  store.notifications = [
    { id: "N1", type: "interview", title: "Interview scheduled", message: `Your interview for ${job7 ? job7.title : "the role"} is confirmed.`, date: daysAgo(1), read: false },
    { id: "N2", type: "status", title: "Application shortlisted", message: `You were shortlisted for ${job7 ? job7.title : "a role"} at ${job7 ? job7.company : ""}.`, date: daysAgo(5), read: false },
    { id: "N3", type: "offer", title: "Offer sent", message: "Sen Vang Group sent you an offer.", date: daysAgo(10), read: true },
    ...
    { id: "N5", type: "confirmation", title: "Application submitted", message: `Your application for ${job1 ? job1.title : "a role"} was received.`, date: daysAgo(2), read: true },
  ];
...
export function addNotification(n) {
  const store = ensureSeeded();
  const record = { id: "N" + Date.now(), read: false, date: new Date().toISOString().slice(0, 10), ...n };
