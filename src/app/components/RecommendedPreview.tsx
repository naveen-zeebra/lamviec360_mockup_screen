    ...
    <section className="section-padding bg-muted/30" aria-labelledby="recommended-preview-heading">
      <div className="max-w-screen-2xl mx-auto px-4 lg:px-8 xl:px-10">
        <div className="flex items-end justify-between mb-8">
          <div>
            <p className="text-xs font-semibold text-primary uppercase tracking-widest mb-2">Cơ Hội Cá Nhân Hóa</p>
            ...
            <p className="text-base text-muted-foreground mt-2">
              Khám phá cơ hội dựa trên hồ sơ và hoạt động tìm việc của bạn.
            </p>
          </div>
          <Link
