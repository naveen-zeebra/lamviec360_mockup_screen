...
export default function HowItWorks({ t }: { t: TranslationKeys }) {
  const steps = [
    {
      number: '01',
      icon: UserCircle,
    ...
    <section className="section-padding bg-muted/30" aria-labelledby="how-it-works-heading">
      <div className="max-w-screen-2xl mx-auto px-4 lg:px-8 xl:px-10">
        <div className="text-center mb-12">
          <p className="text-xs font-semibold text-primary uppercase tracking-widest mb-2">{t.howItWorks.eyebrow}</p>
